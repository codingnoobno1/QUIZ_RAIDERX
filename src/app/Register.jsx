  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="100vh" bgcolor="#f0f4f8">
      <Paper elevation={6} sx={{ p: 4, maxWidth: 400, width: "100%" }}>
        <Typography variant="h5" fontWeight="bold" color="primary" mb={2} textAlign="center">
          Register
        </Typography>
...
const InputField = ({ label, name, type = "text", value, onChange }) => (
  <TextField label={label} name={name} type={type} value={value} onChange={onChange} fullWidth margin="normal" variant="outlined" required />
);
